...
def parse_args():
    p = argparse.ArgumentParser(
        description="Aggregate roboblock.json and send short summary to Telegram"
    )
...
def main():
    ...
    header_lines.append(
        f"Всего ставок: {stats['filtered_count']}, Побед: {stats['wins_count']}, Поражений: {stats['losses_count']}, Отмен: {stats['cancelled_count']}"
    )
